...
I'm currently pursuing my Master's in Computer Engineering 🤖, with a focus on Computer Vision, Deep Learning and building software projects for fun.

My background is in hardware/software system-level design, and previously developed high-precision laser projectors for augmented reality applications. devices used to support to construction of some of the most advanced machines in the world.
